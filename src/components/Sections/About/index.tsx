...
export const About = () => {
  return (
    <section className="relative centered py-y-default" id="about-me__section">
      <div className="content-width flex gap-7">
        <figure className="min-w-[16.875rem] w-[60vw] max-w-[30rem] min-h-[16.875rem] h-full max-h-[30rem]">
          <Image
            className="block w-full h-full w-full border-solid border-4 border-gray-100 medium:w-full medium:h-[18.75rem] "
            src={developerImg}
        ...
        <div className="w-full flex flex-col justify-between items-start gap-10">
          ...
          <button
            className="text-base bg-highlight p-2 rounded-md"
